locals {
  root_domain_name     = "staging.nafnaval.is"
  www_domain_name      = "stagingwww.nafnaval.is"
  lambda_function_name = "staging-nafnaval-api-lambda"
  dynamo_table_name    = "staging-nafnaval-names"
}
